...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<header role="banner" id="fh5co-header">
			<div class="container">
		        ...
		        <div class="navbar-header">
		         ...
		         <a class="navbar-brand" href="index.html">Meteran Hati</a> 
		        </div>
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-5 col-md-offset-1">
							<image src="images/new-contact.png" width="100" height="100" >
							<h2 class="to-animate">Add new card</h2>
						</div>
                        <div class="col-md-6 ">
							<image src="images/no-credit.png" width="100" height="100" class="to-animate">
                            <h2 class="to-animate">Block a card</h2>
						</div>
					</div>
				</div>
			</div>
	...
	<section id="fh5co-contact" data-section="add">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h3>Please fill in the following form for adding a new card.</h3>
						</div>
					</div>
				</div>
			</div>
	...
	<section id="fh5co-about" data-section="block">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">Block A Card</h2>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h3>Please fill in the following form for blocking a card.</h3>
						</div>
					</div>
				</div>
			</div>
	       ...
	       <div class="col-md-12 to-animate">
                <div class="form-group ">
                    ...
                    <input name="id-blocked" id="id-blocked" class="form-control" placeholder="Id Card" type="text">
                </div>
               <div class="form-group ">
                    <label for="reason-blocked" class="sr-only"></label>
                   <textarea name="reason-blocked" id="reason-blocked" class="form-control" rows="5" placeholder="Reason Blocked"></textarea>
                </div>
                <center>
                    <div class="form-group ">
                        <input class="btn btn-primary btn-lg" value="Submit" type="submit">
